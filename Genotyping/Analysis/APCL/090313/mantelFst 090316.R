...
plot(cebu_geo[1:100], cebu_fst[1:100], pch=1, xlab="Geographic Distance (km)", ylab="Fst/(1-Fst)", main="Cebu")
...
plot(leyte_geo[1:64], leyte_fst[1:64], pch=1, xlab="Geographic Distance (km)", ylab="Fst/(1-Fst)", main="Leyte")
...
# remove pop #18 from Leyte: plot with Cebu
quartz(width=9, height=5)
par(mfrow=c(1,2))
ylims =c(0, 0.03)
...
# or plot leyte w/out #18 against cebu
plot(leyte_geono18[1:64], leyte_fstno18[1:64], xlab="Geographic Distance (km)", ylab="Fst/(1-Fst)", col="blue", pch=16)
l = lm(leyte_fstno18[lower.tri(leyte_fstno18)] ~ leyte_geono18[lower.tri(leyte_geono18)])
lines(leyte_geono18[1:64][!is.na(leyte_geono18[1:64])], l$fitted.values, col="blue")

points(cebu_geo[1:100], cebu_fst[1:100], pch=1, col="orange")
l = lm(cebu_fst[lower.tri(cebu_fst)] ~ cebu_geo[lower.tri(cebu_geo)])
lines(cebu_geo[lower.tri(cebu_geo)], l$fitted.values, col="orange")
summary(l)$coefficients

legend("topright", legend=c("Leyte", "Cebu"), pch=c(16,1), col=c("blue", "orange"))


# plot leyte w/out 18 combined with cebu
plot(c(leyte_geono18[1:64],cebu_geo[1:100]), c(leyte_fstno18[1:64],cebu_fst[1:100]), xlab="Geographic Distance (km)", ylab="Fst/(1-Fst)", col="blue", pch=16)
l = lm(c(leyte_fstno18[lower.tri(leyte_fstno18)],cebu_fst[lower.tri(cebu_fst)]) ~ c(leyte_geono18[lower.tri(leyte_geono18)],cebu_geo[lower.tri(cebu_geo)]))
lines(c(leyte_geono18[lower.tri(leyte_geono18)],cebu_geo[lower.tri(cebu_geo)]), l$fitted.values, col="blue")
summary(l)$coefficients
...
summary(lm(leyte_fst[lower.tri(leyte_fst)] ~ leyte_geolong[lower.tri(leyte_geolong)]))$coefficients

plot(leyte_geo[1:64], leyte_fst[1:64], pch=1, xlab="Geographic Distance (km)", ylab="Fst/(1-Fst)", xlim=c(0,300))
l = lm(leyte_fst[lower.tri(leyte_fst)] ~ leyte_geo[lower.tri(leyte_geo)])
...
len = 10000 # how many iterations?
	...
	m = rnorm(len, mean=6.90e-05, sd=0.000024) # slope of IBD using Leyte w/ pop 18
#	m = rnorm(len, mean=2.56e-05, sd=0.00001107) # slope of IBD using Cebu and Leyte together
