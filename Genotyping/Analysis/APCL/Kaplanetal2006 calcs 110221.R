...
## Spatial scale: 10 "units" equal 1 km
## MPAs of various widths with FNEPR fished=0.2
fsat = 0.35
fneprfish5 = 0.2
mpa1 = c(20, 50, 90, 120) # 2km, 5, 9, 12
nummpas = c(3, 3, 3, 3)
shoulders1 = c(100,100,100, 100) # mpa spacing 10 km
fnepr5 = c(rep(c(rep(fneprfish5, shoulders1[1]), rep(1, mpa1[1])), nummpas[1]), rep(fneprfish5, shoulders1[1]))
fnepr6 = c(rep(c(rep(fneprfish5, shoulders1[2]), rep(1, mpa1[2])), nummpas[2]), rep(fneprfish5, shoulders1[2]))
fnepr7 = c(rep(c(rep(fneprfish5, shoulders1[3]), rep(1, mpa1[3])), nummpas[3]), rep(fneprfish5, shoulders1[3]))
fnepr8 = c(rep(c(rep(fneprfish5, shoulders1[4]), rep(1, mpa1[4])), nummpas[4]), rep(fneprfish5, shoulders1[4]))
fnepr5to8 = list(fnepr5, fnepr6, fnepr7, fnepr8)

a5 = kaplan(110, fnepr5, fsat, 100)
a6 = kaplan(110, fnepr6, fsat, 100)
a7 = kaplan(110, fnepr7, fsat, 100)
a8 = kaplan(110, fnepr8, fsat, 100)
a5to8 = list(a5, a6, a7, a8)
...
plot(-1, -1, xlim=c(0,1), ylim=c(0,1), xaxt="n", yaxt="n", bty="n", xlab="", ylab="")
legend("left", legend=c(0.2, "MPA"), lty=c(1, 1), lwd=c(1, 5), bty="n", title="FNEPR in\nfished areas", col=c(rep("black", 1), "grey"))
