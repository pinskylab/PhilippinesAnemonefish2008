...
redos[, grep("ACH_B9|NNG_004|NNG_007|NNG_028", colnames(redos))]
...
old = read.csv("PRBI_genotypes_2009-09-07.csv", row.names=1)
...
setwd("/Users/mpinsky/Documents/Stanford/Philippines/2008/Genotyping/Genotypes")
geno = read.csv("PRBI_genotypes_2009-09-23.csv", row.names=1)
###################################################
