...
i = geno$hom & geno$numgenos < 2 & (geno$Marker == "ACH_B9" | geno$Marker == "NNG_004" | geno$Marker == "NNG_007" | geno$Marker == "NNG_028")
sum(i)
table(i, geno$Marker)
j = table(i, geno$Sample)
j[, j[2,]>0]
redos = table(geno$Sample[i], geno$Marker[i])
redos = redos[rowSums(redos)>0,]
redos
redos[redos[,1]>0 | redos[,3]>0,c(1,3)] # redo ACH_B9 and NNG_007
redos[redos[,3]>0,c(3)] # redo NNG_007
...
setwd("/Users/mpinsky/Documents/Stanford/Philippines/2008/Genotyping/Genotypes")
geno = read.csv("PRBI_genotypes_2009-09-07.csv", row.names=1)
###################################################
