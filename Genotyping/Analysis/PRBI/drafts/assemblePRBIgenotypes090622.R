...
#file1 = read.table("AFG1-3_PRBI Genotypes 090621.txt", header = T, sep ="\t", na.string="?")
file1 = read.table("AFG1-3_PRBI Genotypes 090621.txt", header = T, sep ="\t", colClasses = colstoread, na.string="?")
...
a1 = geno$Sample[geno$Marker=="AC1359" & is.na(geno$A1consens)]
a2 = geno$Sample[geno$Marker=="APR_Cf29" & is.na(geno$A1consens)]
a3 = geno$Sample[geno$Marker=="NNG_012" & is.na(geno$A1consens)]
out = matrix(nrow = max(length(a1),length(a2),length(a3)), ncol = 3)
out[1:length(a1),1] = a1
out[1:length(a2),2] = a2
out[1:length(a3),3] = a3
colnames(out) = c("AC1359", "APR_Cf29", "NNG_012")
#write.csv(out, paste("MissingPRBI_", Sys.Date(), ".csv", sep=""))
