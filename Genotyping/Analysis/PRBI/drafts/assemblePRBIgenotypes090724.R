...
afg46 = read.table("AFG46-47_PRBI_MLP Genotypes 090724.txt", header = T, sep ="\t", na.string="?")
afg48 = read.table("AFG48_PRBI_MLP Genotypes 090724.txt", header = T, sep ="\t", na.string="?")
afg49 = read.table("AFG49_PRBI_MLP Genotypes 090714.txt", header = T, sep ="\t", na.string="?")
...
afg6.m = read.table("../MattGribble/AFG6-7.M_PRBI_MG Genotypes 090724.txt", header=T, sep="\t", na.string="?")
afg8.m = read.table("../MattGribble/AFG8.M_PRBI_MG Genotypes 090724.txt", header=T, sep="\t", na.string="?")
afg9.m = read.table("../MattGribble/AFG9.M_PRBI_MG Genotypes 090710.txt", header=T, sep="\t", na.string="?")

afg51 = read.table("../MattGribble/AFG51_PRBI_MG Genotypes 090723.txt", header = T, sep ="\t", na.string="?")
afg52 = read.table("../MattGribble/AFG52_PRBI_MG Genotypes 090723.txt", header = T, sep ="\t", na.string="?")
afg53 = read.table("../MattGribble/AFG53_PRBI_MG Genotypes 090724.txt", header = T, sep ="\t", na.string="?")
afg54 = read.table("../MattGribble/AFG54_PRBI_MG Genotypes 090723.txt", header = T, sep ="\t", na.string="?")
afg55 = read.table("../MattGribble/AFG55_PRBI_MG Genotypes 090724.txt", header = T, sep ="\t", na.string="?")
afg56 = read.table("../MattGribble/AFG56_PRBI_MG Genotypes 090723.txt", header = T, sep ="\t", na.string="?")
afg57 = read.table("../MattGribble/AFG57_PRBI_MG Genotypes 090723.txt", header = T, sep ="\t", na.string="?")

afg1 = afg1[,colstoread]
afg9 = afg9[,colstoread]
afg1_3.m.mlp = afg1_3.m.mlp[,colstoread]
afg4_5.m.mlp = afg4_5.m.mlp[,colstoread]
afg46 = afg46[,colstoread]
afg48 = afg48[,colstoread]
afg49 = afg49[,colstoread]
...
afg6.m = afg6.m[,colstoread]
afg8.m = afg8.m[,colstoread]
afg9.m = afg9.m[,colstoread]
afg51 = afg51[,colstoread]
afg52 = afg52[,colstoread]
afg53 = afg53[,colstoread]
afg54 = afg54[,colstoread]
afg55 = afg55[,colstoread]
afg56 = afg56[,colstoread]
afg57 = afg57[,colstoread]
...
colnames(afg52) = paste(colnames, c("","",".AFG52", ".AFG52"), sep="")
colnames(afg53) = paste(colnames, c("","",".AFG53", ".AFG53"), sep="")
colnames(afg54) = paste(colnames, c("","",".AFG54", ".AFG54"), sep="")
colnames(afg55) = paste(colnames, c("","",".AFG55", ".AFG55"), sep="")
colnames(afg56) = paste(colnames, c("","",".AFG56", ".AFG56"), sep="")
colnames(afg57) = paste(colnames, c("","",".AFG57", ".AFG57"), sep="")
...
afg52 = afg52[intersect(grep("PRBI",afg52$Sample), which(!is.na(afg52$A1))),] # remove extra genotypes from AFG52
afg53 = afg53[intersect(grep("PRBI",afg53$Sample), which(!is.na(afg53$A1))),] # remove extra genotypes from AFG53
afg54 = afg54[intersect(grep("PRBI",afg54$Sample), which(!is.na(afg54$A1))),] # remove extra genotypes from AFG54
afg55 = afg55[intersect(grep("PRBI",afg55$Sample), which(!is.na(afg55$A1))),] # remove extra genotypes from AFG55
afg56 = afg56[intersect(grep("PRBI",afg56$Sample), which(!is.na(afg56$A1))),] # remove extra genotypes from AFG56
afg57 = afg57[intersect(grep("PRBI",afg57$Sample), which(!is.na(afg57$A1))),] # remove extra genotypes from AFG57
...
which(duplicated(paste(afg52$Sample, afg52$Marker)))
which(duplicated(paste(afg53$Sample, afg53$Marker)))
which(duplicated(paste(afg54$Sample, afg54$Marker)))
which(duplicated(paste(afg55$Sample, afg55$Marker)))
which(duplicated(paste(afg56$Sample, afg56$Marker)))
which(duplicated(paste(afg57$Sample, afg57$Marker)))
...
sum(duplicated(paste(afg51$Sample, afg51$Marker))) == sum(duplicated(paste(afg51$Sample, afg51$Marker, afg51$A1, afg51$A2)))
sum(duplicated(paste(afg55$Sample, afg55$Marker))) == sum(duplicated(paste(afg55$Sample, afg55$Marker, afg55$A1, afg55$A2)))
sum(duplicated(paste(afg56$Sample, afg56$Marker))) == sum(duplicated(paste(afg56$Sample, afg56$Marker, afg56$A1, afg56$A2)))

# trim duplicates from file_ (AFG__) and file_ (AFG__)
afg1 = afg1[!duplicated(paste(afg1$Sample, afg1$Marker)),]
afg51 = afg51[!duplicated(paste(afg51$Sample, afg51$Marker)),]
afg55 = afg55[!duplicated(paste(afg55$Sample, afg55$Marker)),]
afg56 = afg56[!duplicated(paste(afg56$Sample, afg56$Marker)),]
...
dim(geno)
geno = merge(geno, afg52, all.x=T, all.y = T, by = c("Sample", "Marker"))
dim(geno)
geno = merge(geno, afg53, all.x=T, all.y = T, by = c("Sample", "Marker"))
dim(geno)
geno = merge(geno, afg54, all.x=T, all.y = T, by = c("Sample", "Marker"))
dim(geno)
geno = merge(geno, afg55, all.x=T, all.y = T, by = c("Sample", "Marker"))
dim(geno)
geno = merge(geno, afg56, all.x=T, all.y = T, by = c("Sample", "Marker"))
dim(geno)
geno = merge(geno, afg57, all.x=T, all.y = T, by = c("Sample", "Marker"))
dim(geno)
...
setwd("/Users/mpinsky/Documents/Stanford/Philippines/2008/Genotyping/Genotypes")
geno = read.csv("PRBI_genotypes_2009-07-24.csv", row.names=1)
...
dim(genowide)
	...
	# Write to file
	file = file(paste("PRBI_create_", Sys.Date(), ".csv", sep=""))
	open(file, "w")
