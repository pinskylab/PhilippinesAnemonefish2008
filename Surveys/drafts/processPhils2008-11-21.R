...
collections = data.frame(SurveyNum = character(0), ObsTime = character(0), Spp = character(0), Size1 = numeric(0), ID1 = character(0), Notes=character(0))
...
names(collections) = c("SurveyNum", "Time", "Spp", "Size", "ID", "Notes")
collections$lat = NA
collections$long = NA
...
write.csv(surv, "surveys2008-11-22.density.csv")
...
surv=read.csv("surveys2008-11-22.density.csv")
