...
# FOR EVOL PAPER: A clarkii fish and adults/m2 for Cebu and Leyte, Random and Non-Random Linear Fish Surveys
...
sd(aggregate(a$densAPCL[k], by=list(a$SiteNum[k]), mean)$x)/sqrt(length(unique(a$SiteNum[k]))) # mean density across non-random sites
